...
public class Model2 {
	...
	private TreeMap<String, ArrayList<String>> raw = new TreeMap<>();
	
	public TreeMap<String, ArrayList<String>> build() {
		build("1", line1);
		build("2", line2);
		build("3", line3);
		build("4", line4);
	...
	private void build(String key, String values) {

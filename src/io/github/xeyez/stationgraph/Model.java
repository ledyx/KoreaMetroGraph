...
public class Model {
	...
	private String line2 = "까치산 신정네거리 양천구청 도림천 신도림 신설동 용두 신답 용답 성수 시청 충정로 아현 이대 신촌 홍대입구 합정 당산 영등포구청 문래 신도림 대림 구로디지털단지 신대방 신림 봉천 서울대입구 낙성대 사당 방배 서초 교대 강남 역삼 선릉 삼성 종합운동장 잠실새내 잠실 잠실나루 강변 구의 건대입구 성수 뚝섬 한양대 왕십리 상왕십리 신당 동대문역사문화공원 을지로4가 을지로3가 을지로입구 시청";
	...
	private String line7 = "부평구청 굴포천 삼산체육관 상동 부천시청 신중동 춘의 부천종합운동장 까치울 온수 천왕 광명사거리 철산 가산디지털단지 남구로 대림 신풍 보라매 신대방삼거리 장승배기 상도 숭실대입구 남성 이수 내방 고속터미널 반포 논현 학동 강남구청 청담 뚝섬유원지 건대입구 어린이대공원 군자 중곡 용마산 사가정 면목 상봉 중화 먹골 태릉입구 공릉 하계 중계 노원 마들 수락산 도봉산 장암";
	...
	// 공항
	private String lineA = "서울 공덕 홍대입구 디지털미디어시티 김포공항 계양 검암 청라국제도시 영종 운서 공항화물청사 인천국제공항";
	...
	// 신분당
	private String lineS = "광교 광교중앙 상현 성복 수지구청 동천 정자 판교 청계산입구 양재시민의숲 양재 강남";
